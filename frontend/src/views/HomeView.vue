...
// Use the composable
const { calculatedCost, calculateCost: composableCalculateCost } = useShipmentCalculator();
...
>
  <!-- --- Real-Time Tracking --- -->
  <v-carousel-item>
    <v-card class="pa-6 fade-in-section mx-auto" elevation="3" max-width="95%">
      <h3 class="text-h4 font-weight-bold mb-4 text-center">Real-Time Tracking</h3>
      ...
      <p class="text-body-1 px-4">
        Follow your shipment every step of the way with instant updates powered by advanced GPS
        and monitoring systems. Track your parcels across multiple checkpoints to ensure full
        transparency from pickup to delivery. With real-time notifications, you stay in control
  ...
  <v-carousel-item>
    <v-card class="pa-6 fade-in-section mx-auto" elevation="3" max-width="95%">
      ...
      <p class="text-body-1 px-4">
        Our optimized delivery routes ensure your packages arrive quickly and safely. Powered by
        smart logistics planning and real-time traffic evaluation, our delivery system minimizes
        delays and maximizes efficiency. Whether across town or nationwide, TrackFast delivers
        with speed you can trust.
      </p>
    </v-card>
  </v-carousel-item>
  ...
  <v-carousel-item>
    <v-card class="pa-6 fade-in-section mx-auto" elevation="3" max-width="95%">
      <h3 class="text-h4 font-weight-bold mb-4 text-center">Secure & Reliable</h3>
      ...
      <p class="text-body-1 px-4">
        Every package is handled with strict security protocols and monitored through each stage
        of the process. From warehouse storage to delivery hand-off, TrackFast ensures that your
        items are protected and transported with care. Reliability and security are built into
        every shipment.
      </p>
    </v-card>
  </v-carousel-item>
...
.hero-section {
  background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)),
    url("https://images.unsplash.com/photo-1586528116508-1a67d1d9634a?auto=format&fit=crop&w=1500&q=80");
